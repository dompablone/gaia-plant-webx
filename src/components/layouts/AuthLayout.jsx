      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <img src={GAIA_ICON} alt="Gaia Plant" style={{ height: 44, width: "auto", objectFit: "contain" }} />
            <div style={{ fontWeight: 900, fontSize: 18, color: "#fff" }}>Gaia Plant</div>
          </div>

          <div style={{ marginTop: 18, fontSize: 34, fontWeight: 950, lineHeight: 1.05, color: "#fff" }}>
            Cannabis medicinal <br /> com clareza e segurança.
          </div>

          <div style={{ marginTop: 12, opacity: 0.92, fontSize: 14, lineHeight: 1.5, maxWidth: 420, color: "#fff" }}>
            Conteúdos educativos, triagem guiada e um caminho simples até o seu acompanhamento. Tudo em um fluxo curto e
            objetivo.
          </div>
          ...
          <div style={{ marginTop: 18, display: "flex", gap: 10, flexWrap: "wrap" }}>
            ...
            <Link to="/criar-conta" className="gaia-btn gaia-btn-outline" style={{ color: "#111", textDecoration: "none" }}>
              Criar conta
            </Link>
          </div>
